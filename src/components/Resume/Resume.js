...
import pdf from "../../Assets/Divitha Resume.pdf";
      ...
      <Container>
        ...
        <Row className="resume">
          ...
          <Col md={6} className="resume-right">
            ...
            <Resumecontent
              title="computer science engineering(BIT,Bangalore) "
              date="2018 - Present"
              content={[`CGPA: ${cgpa} (Till ${sem}th Sem)`]}
            />
            <Resumecontent
              title="12TH BOARD [Andhra pradesh state board]"
              date="2016 - 2018"
              content={["Precentage: 97.9%"]}
            />
            <Resumecontent
              title="10TH BOARD [Andhra pradesh state board] "
              date="2005 - 2016"
              content={["CGPA:9.8"]}
            />
